...
<html lang="en">
  <head>
    ...
    <meta name="Description" content="Q&A Forum - GROUP CT_PHAM! Update">
	<meta name="author" content="GROUPCT_PHAMDesigns">
    <link rel="icon" href="../favicon.ico">

    <title>GROUP CT_PHAM! Update</title>
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <div class="navbar-header" style="">
		  ...
		  <a class="navbar-brand" href="#me" style="font-family:Lobster, Tahoma, Arial; color:#b92b27;font-size:25px">GROUP CT_PHAM! Update</a>
        </div>
...
<div class="row">
	...
	<div class="col-md-9">
		...
		<div class= "page-header">
			<h3>Welcome to GROUP CT_PHAM! Update script<small class="pull-right">[ Step <?php echo $step; ?> of <?php echo $steps; ?> ]</small></h3>
		</div>
		...
		switch($step) {
			...
			?>
			<div style="color:black; font-size:16px">
				<h3 style="color:green">Congratulations! You've upgraded (GROUP CT_PHAM) !</h3><br>
	...
	<a href="http://pomelonow.com" target="_blank">GROUP CT_PHAM Designs </a>&copy; 2017
	</div>	
