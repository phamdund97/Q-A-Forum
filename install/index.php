...
<html lang="en">
  <head>
    ...
    <meta name="Description" content="GROUP CT_PHAM! Installer">
	<meta name="author" content="GROUP CT_PHAMDesigns">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
		...
		<ul class="nav navbar-nav navbar-right">
            ...
            <li class=''><a href="mailto:phamdund97@gmail.com"><i class="glyphicon glyphicon-exclamation-sign"></i>&nbsp;&nbsp;Support</a></li>
          </ul>
...
<div class="row">
	...
	<div class="col-md-9">
		...
		<div class= "page-header">
			<h3>Welcome to Q&A Forum! installer script<small class="pull-right">[ Step <?php echo $step; ?> of <?php echo $steps; ?> ]</small></h3>
		</div>
		...
		switch($step) {
				...
				Thanks for install Q&A Forum!<br>Now let's break the ice between Q&A Forum and your server ;)
			...
			Q&A Forum! uses some open source tools for security, analytics and sharing functions, please follow these steps to properly install them
			...
			?>
			<div style="color:black; font-size:16px">
				Great! Now tell Q&A Forum more about you!<br>
			...
			?>
			<div style="color:black; font-size:16px">
				<h3 style="color:green">Congratulations! You've installed (Q&A Forum) !</h3><br>
				...
				<h4>Feel free to <a href="mailto:michael.zohney@gmail.com">Contact Me</a> anytime at phamdund97@gmail.com ;)</h4>
			</div>
	...
	<a href="http://michael-designs.com" target="_blank">GROUP CT_PHAM Designs </a>&copy; 2017
	</div>	
